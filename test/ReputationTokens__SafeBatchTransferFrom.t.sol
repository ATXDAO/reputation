...
contract ReputationTokens__SafeBatchTransferFrom is
    ReputationTokensTest__Base
{
    ...
    function testSafeBatchTransferFrom(uint256 user2Id)
        public
        onlyValidAddress(user2Id)
    {
        ...
        vm.prank(user1);
        s_repTokens.safeBatchTransferFrom(user1, user2, tokenIds, values, "");
    }
}
